...
import './AddSendPayment.css'

// Router
import { useHistory } from 'react-router-dom'

const AddSendPayment = () => {
  const history = useHistory()
  const handleChangePage = value => {
    history.push(value)
  }
  return (
    <div className="add-send-payment">
      <p style={{ fontSize: '22px', color: '#637685', fontWeight: '700' }}>Send Payment for Invoices</p>
      <hr />
      <form>
        <div className="mt-4">
        ...
        <div className="mt-5">
          ...
          <div>
            <button className="btn btn-primary btn-sm" type="button">Choose Purchase Invoice</button>
          </div>
