...
const AddPurchaseInvoice = () => {
  return (
    <div className="add-purchase-invoice">
      <p style={{ fontWeight: '700', fontSize: '18px', color: '#3C5468' }}>Create Purchase Invoice</p>
      <div className="container-form-add-invoice">
        ...
        <div className="row justify-content-between" style={{ marginTop: '60px' }}>
          ...
          <div className="col">
            <p style={{ fontSize: '20px', color: '#327EAC' }}>Supplier Information</p>
            <hr />
          </div>
        </div>
        ...
        <div className="row">
          <div className="col text-center">
            <button className="btn btn-primary">Save and Confirm Invoice</button>
          </div>
        </div>
      </div>
    </div>
